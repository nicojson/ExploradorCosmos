...
public class Publication {
    ...
    public int getSourceApiId() { return sourceApiId; }
    public void setSourceApiId(int sourceApiId) { this.sourceApiId = sourceApiId; }
    public String getOriginalIdFromApi() { return originalIdFromApi; }
    public void setOriginalIdFromApi(String originalIdFromApi) { this.originalIdFromApi = originalIdFromApi; }
