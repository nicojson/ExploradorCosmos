...
public class DatabaseManager {
    ...
    private static final String DATABASE_USER = "root";//modificar estos datos en cada computadora
    private static final String DATABASE_PASSWORD = "B160819fgta"; //modificar estos datos en cada computadora
